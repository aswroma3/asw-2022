...
echo Starting Word Services [subject*1 + subject*1 failure=25 + verb*2 + object *1 + object *1 failure=25]
...
java -Xms64m -Xmx128m -jar -Dspring.profiles.active=subject -Dasw.sentence.wordservice.instancename=s2 -Dasw.sentence.wordservice.failurerate=25 word-service/build/libs/word.jar &
