...
Questo progetto contiene alcune applicazioni che esemplificano il rilascio di applicazioni composte da uno o più servizi, eseguite mediante la composizione di container Docker. 
