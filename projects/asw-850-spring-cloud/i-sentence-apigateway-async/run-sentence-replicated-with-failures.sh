...
echo Starting Word Services [subject*1 + subject*1 failure=50 + verb*2 + object *1 + object *1 failure=25]
...
java -Xms64m -Xmx128m -jar -Dspring.profiles.active=subject -Dasw.sentence.wordservice.instancename=s2 -Dasw.sentence.wordservice.failurerate=50 word-service/build/libs/word.jar &
...
java -Xms64m -Xmx128m -jar -Dasw.sentence.sentenceservice.instancename=S2 sentence-service-async/build/libs/sentence-async.jar &
